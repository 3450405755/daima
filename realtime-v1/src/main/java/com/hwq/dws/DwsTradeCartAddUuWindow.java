...
// 最大并发检查点数
        ...
        SingleOutputStreamOperator<String> page_filter = page.filter(new FilterFunction<String>() {
            @Override
        ...
        SingleOutputStreamOperator<String> page_water = page_filter.assignTimestampsAndWatermarks(WatermarkStrategy.<String>forMonotonousTimestamps().withTimestampAssigner(new SerializableTimestampAssigner<String>() {
        ...
        SingleOutputStreamOperator<String> map = reduceDS.map(o -> JSON.toJSONString(o));
        //map.print();
