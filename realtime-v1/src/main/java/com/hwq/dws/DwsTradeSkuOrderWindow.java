...
// 最大并发检查点数
        ...
        SingleOutputStreamOperator<JSONObject> distinctDS = orderDetailjs.process(new KeyedProcessFunction<String, JSONObject, JSONObject>() {
            ...
            public void open(Configuration parameters) throws Exception {
                ValueStateDescriptor<JSONObject> value1
                        = new ValueStateDescriptor<JSONObject>("sate", JSONObject.class);
        ...
        //TODO 7.开窗
        WindowedStream<TradeSkuOrderBean, String, org.apache.flink.streaming.api.windowing.windows.TimeWindow> windowDS =
       ...
       //withCategory2foDS.print();
        ...
        SingleOutputStreamOperator<String> map = withCategory1foDS.map(o -> JSON.toJSONString(o));
        //map.print();
