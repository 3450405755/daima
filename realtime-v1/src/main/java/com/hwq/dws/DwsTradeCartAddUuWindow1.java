...
/**
 * @Package com.hwq.dws.DwsTradeCartAddUuWindow1
 * @Author hu.wen.qi
...
// 最大并发检查点数
        ...
        //cart.print();
        SingleOutputStreamOperator<JSONObject> jsonObjDS = cart.map(o -> JSON.parseObject(o));
        //jsonObjDS.print();
        ...
        SingleOutputStreamOperator<String> map = aggregateDS.map(o -> JSON.toJSONString(o));
